...
SECRET_KEY = "TeriGanDMeinLoda9824@#1!"  # 🔥 CHANGE THIS!

def get_encryption_key():
    """Generate a Fernet key from the secret"""
...
<body data-theme="dark">
  ...
  <div class="container">
    ...
    <footer>
      Click on any educator, batch, or course to navigate and explore. 🔐 Secured with encryption
    </footer>
  </div>
